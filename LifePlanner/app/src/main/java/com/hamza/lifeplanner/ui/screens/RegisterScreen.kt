...
fun RegisterScreen(
    ...
    // Estado de carga mientras Firebase crea la cuenta
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Empieza a organizar tus tareas, hábitos y calendario.",
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Crea tu cuenta para guardar tu progreso en Firebase.",
                        color = Color(0xFF777777),
                            ...
                            when {
                                ...
                                password != repeatPassword -> {
                                    ...
                                    authRepository.register(
                                        ...
                                        onError = {
                                            loading = false
                                            errorMessage = "No se pudo crear la cuenta. Prueba con otro correo."
                                        }
                                    )
                                }
                            }
